...
function setDoorLocking(doorId, key)
    ...
    SetTimeout(800, function()
		...
		TriggerServerEvent('mrp-doorlock:server:updateState', key, doorId.locked)
	end)
end
...
RegisterNetEvent('mrp-doorlock:client:setState')
AddEventHandler('mrp-doorlock:client:setState', function(doorID, state)
	Config.Doors[doorID].locked = state
end)

RegisterNetEvent('mrp-doorlock:client:setDoors')
AddEventHandler('mrp-doorlock:client:setDoors', function(doorList)
